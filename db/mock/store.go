...
// Source: github.com/vantu-fit/master-go-be/db/sqlc (interfaces: Store)
...
// ListAccountsOwner mocks base method.
func (m *MockStore) ListAccountsOwner(arg0 context.Context, arg1 db.ListAccountsOwnerParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccountsOwner", arg0, arg1)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAccountsOwner indicates an expected call of ListAccountsOwner.
func (mr *MockStoreMockRecorder) ListAccountsOwner(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccountsOwner", reflect.TypeOf((*MockStore)(nil).ListAccountsOwner), arg0, arg1)
}
